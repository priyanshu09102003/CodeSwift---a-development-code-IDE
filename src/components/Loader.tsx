...
export function Loader() {
  ...
  return (
    <div className="blue-gradient-bg fixed inset-0 z-[100] flex h-full w-full flex-col items-center justify-center gap-6" ref={containerRef}>
      <h1 className="text-white text-5xl font-bold mb-2">CodeSwift</h1>
      <svg
